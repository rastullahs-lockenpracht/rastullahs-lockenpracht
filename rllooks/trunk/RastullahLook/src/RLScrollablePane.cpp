...
namespace CEGUI
{
    ...
    const utf8 RLScrollablePane::WidgetTypeName[] = "RastullahLook/ScrollablePane";
    // component widget type names
    const utf8* RLScrollablePane::HorzScrollbarTypeName = RLMiniHorzScrollbar::WidgetTypeName;
    const utf8* RLScrollablePane::VertScrollbarTypeName = RLMiniVertScrollbar::WidgetTypeName;
    //////////////////////////////////////////////////////////////////////////

    RLScrollablePane::RLScrollablePane(const String& type, const String& name) :
        ScrollablePane(type, name)
    {
    }

    RLScrollablePane::~RLScrollablePane(void)
    {
    }

    Scrollbar* RLScrollablePane::createHorizontalScrollbar(const String& name) const
    {
    ...
    Scrollbar* RLScrollablePane::createVerticalScrollbar(const String& name) const
    {
    ...
    Rect RLScrollablePane::getViewableArea(void) const
    {
    ...
    void RLScrollablePane::drawSelf(float z)
    {
    }
