...
namespace CEGUI
{
    const utf8 RLTooltip::WidgetTypeName[] = "RastullahLook/Tooltip";

    RLTooltip::RLTooltip(const String& type, const String& name) :
            Tooltip(type, name),
            d_backgroundCols(0x00FFFFFF, 0x00FFFFFF, 0x00FFFFFF, 0x00FFFFFF),
            d_frameCols(0x00FFFFFF, 0x00FFFFFF, 0x00FFFFFF, 0x00FFFFFF)
    {}

    void RLTooltip::initialise(void)
    {
        Tooltip::initialise();

        Imageset* iset = ImagesetManager::getSingleton().getImageset("RastullahLook");
    ...
    void RLTooltip::drawSelf(float z)
    {
    ...
    void RLTooltip::onSized(WindowEventArgs& e)
    {
    ...
    void RLTooltip::onAlphaChanged(WindowEventArgs& e)
    {
    ...
    *************************************************************************/
    ...
    Window* RLTooltipFactory::createWindow(const String& name)
    {
        RLTooltip* wnd = new RLTooltip(d_type, name);
        wnd->initialise();
