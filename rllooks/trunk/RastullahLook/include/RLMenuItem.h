...
*************************************************************************/
#ifndef _RLMenuItem_h_
#define _RLMenuItem_h_
...
public:
	...
	*************************************************************************/
	/*!
	\brief
		Constructor for RLMenubarItem objects
	*/
	RLMenubarItem(const String& type, const String& name);


	/*!
	\brief
		Destructor for RLMenubarItem objects
	*/
	virtual ~RLMenubarItem(void);
...
public:
    /*************************************************************************
        Construction and Destruction
    *************************************************************************/
    RLMenubarItemFactory(void) : WindowFactory(RLMenubarItem::WidgetTypeName)
    {}

    ~RLMenubarItemFactory(void)
    {}
...
public:
	...
	*************************************************************************/
	/*!
	\brief
		Constructor for RLPopupMenuItem objects
	*/
	RLPopupMenuItem(const String& type, const String& name);


	/*!
	\brief
		Destructor for RLPopupMenuItem objects
	*/
	virtual ~RLPopupMenuItem(void);
...
public:
    /*************************************************************************
        Construction and Destruction
    *************************************************************************/
    RLPopupMenuItemFactory(void) : WindowFactory(RLPopupMenuItem::WidgetTypeName)
    {}

    ~RLPopupMenuItemFactory(void)
    {}
