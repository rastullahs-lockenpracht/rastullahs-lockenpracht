...
*************************************************************************/
#ifndef _RLScrollablePane_h_
#define _RLScrollablePane_h_
...
namespace CEGUI
{
    class RASTULLAHLOOK_API RLScrollablePane : public ScrollablePane
    {
    public:
        /*************************************************************************
            Constants
        ...
        *************************************************************************/
        RLScrollablePane(const String& type, const String& name);
        ~RLScrollablePane(void);
    ...
    /*!
    \brief
        Factory class for producing RLScrollablePane objects
    */
    class RASTULLAHLOOK_API RLScrollablePaneFactory : public WindowFactory
    {
    public:
        /*************************************************************************
            Construction and Destruction
        *************************************************************************/
        RLScrollablePaneFactory(void) : WindowFactory(RLScrollablePane::WidgetTypeName) { }
        ~RLScrollablePaneFactory(void){}
...
#endif	// end of guard _RLScrollablePane_h_
