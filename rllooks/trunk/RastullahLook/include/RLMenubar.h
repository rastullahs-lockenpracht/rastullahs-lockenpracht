...
*************************************************************************/
#ifndef _RLMenubar_h_
#define _RLMenubar_h_
...
public:
	...
	*************************************************************************/
	/*!
	\brief
		Constructor for RLMenubar objects
	*/
	RLMenubar(const String& type, const String& name);


	/*!
	\brief
		Destructor for RLMenubar objects
	*/
	virtual ~RLMenubar(void);
...
public:
    /*************************************************************************
        Construction and Destruction
    *************************************************************************/
    RLMenubarFactory(void) : WindowFactory(RLMenubar::WidgetTypeName)
    {}

    ~RLMenubarFactory(void)
    {}
...
#endif  // end of guard _RLMenubar_h_
