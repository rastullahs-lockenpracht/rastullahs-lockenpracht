...
*************************************************************************/
#ifndef _RLTooltip_h_
#define _RLTooltip_h_
...
namespace CEGUI
{
    ...
    /*!
    \brief
        Tooltip class for the RastullahLook Gui Scheme
    */
    class RASTULLAHLOOK_API RLTooltip : public Tooltip
    {
    public:
        /*************************************************************************
            Constants
        ...
        *************************************************************************/
        RLTooltip(const String& type, const String& name);
        ~RLTooltip(void)
        {}
    ...
    */
    ...
    public:
        ...
        *************************************************************************/
        RLTooltipFactory(void) : WindowFactory(RLTooltip::WidgetTypeName)
        {}

        ~RLTooltipFactory(void)
        {}
...
#endif  // end of guard _RLTooltip_h_
