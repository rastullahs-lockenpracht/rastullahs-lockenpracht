...
*************************************************************************/
#ifndef _RLPopupMenu_h_
#define _RLPopupMenu_h_
...
*/
class RASTULLAHLOOK_API RLPopupMenu : public PopupMenu
{
public:
	/*************************************************************************
		Constants
	...
	*************************************************************************/
	/*!
	\brief
		Constructor for RLPopupMenu objects
	*/
	RLPopupMenu(const String& type, const String& name);


	/*!
	\brief
		Destructor for RLPopupMenu objects
	*/
	virtual ~RLPopupMenu(void);
...
*/
class RASTULLAHLOOK_API RLPopupMenuFactory : public WindowFactory
{
public:
    /*************************************************************************
        Construction and Destruction
    *************************************************************************/
    RLPopupMenuFactory(void) : WindowFactory(RLPopupMenu::WidgetTypeName)
    {}

    ~RLPopupMenuFactory(void)
    {}
...
#endif  // end of guard _RLPopupMenu_h_
