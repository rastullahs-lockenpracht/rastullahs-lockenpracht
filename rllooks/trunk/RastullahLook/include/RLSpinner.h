...
*************************************************************************/
#ifndef _RLSpinner_h_
#define _RLSpinner_h_
...
namespace CEGUI
{
    ...
    */
    ...
    /*!
    \brief
        Factory class for producing RLSpinner objects
    */
    class RASTULLAHLOOK_API RLSpinnerFactory : public WindowFactory
    {
    public:
        /*************************************************************************
            Object Construction and Destruction
        *************************************************************************/
        RLSpinnerFactory(void) : WindowFactory(RLSpinner::WidgetTypeName) { }
        ~RLSpinnerFactory(void){}
...
#endif	// end of guard _RLSpinner_h_
