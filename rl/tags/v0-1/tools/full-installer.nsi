...
Section "Game Content" SEC0001
    SetOutPath $INSTDIR\modules
    SetOverwrite on
    File /r /x rastullah_ogre.cfg /x .svn /x *.svn-base /x *.svn-work ..\rl_dist\modules\*
    WriteRegStr HKLM "${REGKEY}\Components" "Game Content" 1
SectionEnd
...
Section /o "un.Game Content" UNSEC0001
    RMDir /r /REBOOTOK $INSTDIR\modules
    DeleteRegValue HKLM "${REGKEY}\Components" "Game Content"
SectionEnd
...
Function un.onInit
    ...
    !insertmacro SELECT_UNSECTION "Game Content" ${UNSEC0001}
FunctionEnd
