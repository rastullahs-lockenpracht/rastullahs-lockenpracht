...
protected:
    ...
    void testConstruction()
    {
        ...
        Date d(Date::ONE_YEAR * 1 + Date::ONE_MONTH * 1 + Date::ONE_DAY * 3);
        ...
        d = Date(Date::ONE_YEAR * 1023 + Date::ONE_MONTH * 5 + Date::ONE_DAY * 3 + Date::ONE_HOUR * 10
            + Date::ONE_MINUTE * 15 + Date::ONE_SECOND * 44 + 333);
    ...
    void testEquality()
    {
        CPPUNIT_ASSERT_MESSAGE("Sollten nicht gleich sein.", !(date1 == date2));
        date2 = date1;
        CPPUNIT_ASSERT_MESSAGE("Sollten gleich sein.", date1 == date2);
    }
    ...
    void testDayOfWeek()
    {
        ...
        // 22. Ingerimm 22 Hal
        Date d = Date(Date::ONE_YEAR * 1015 + Date::ONE_MONTH * 10 + Date::ONE_DAY * 21);

        CPPUNIT_ASSERT_EQUAL(3, d.getDayOfWeek());

        // Ist laut Fanpro-Tabellenwerk ein Erdstag
        // 4. Namenloser Tag 7 Hal
        d = Date(Date::ONE_YEAR * 1000 + Date::ONE_MONTH * 12 + Date::ONE_DAY * 3);

        CPPUNIT_ASSERT_EQUAL(2, d.getDayOfWeek());

        // Ist laut Fanpro-Tabellenwerk ein Rohalstag
        // 18. Rondra 45 v.H.
        d = Date(Date::ONE_YEAR * 948 + Date::ONE_MONTH * 1 + Date::ONE_DAY * 17);
