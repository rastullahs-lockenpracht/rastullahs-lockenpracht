...
protected:
    ...
    void testAutoCompleteParent1()
    {
        ...
        CPPUNIT_ASSERT_EQUAL_MESSAGE(
            "Quest sollte noch auf UNKNOWN stehen", Quest::UNKNOWN, testObj_Parent->getState());

        testObj_Sub1->setState(Quest::COMPLETED);
        testObj_Sub2->setState(Quest::COMPLETED);
        CPPUNIT_ASSERT_EQUAL_MESSAGE(
            "Parent-Quest sollte auf COMPLETED stehen", Quest::COMPLETED, testObj_Parent->getState());
    ...
    void testAutoCompleteParent2()
    {
        ...
        CPPUNIT_ASSERT_EQUAL_MESSAGE(
            "Sub2-Quest sollte auf COMPLETED stehen", Quest::COMPLETED, testObj_Sub2->getState());
        CPPUNIT_ASSERT_EQUAL_MESSAGE(
            "Parent-Quest sollte auf COMPLETED stehen", Quest::COMPLETED, testObj_Parent->getState());
