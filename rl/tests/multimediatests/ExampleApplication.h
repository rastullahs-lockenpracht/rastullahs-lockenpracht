    ...
    */
    ...
    protected:
        ...
        virtual bool setup(void)
        {
            ...
            //            ResourceGroupManager::getSingleton().addResourceLocation("./modules/minidemo/materials/alpha",
            //            "FileSystem");
            ResourceGroupManager::getSingleton().addResourceLocation("./modules/common/materials/env", "FileSystem");
            //            ResourceGroupManager::getSingleton().addResourceLocation("./modules/minidemo/materials/env",
            //            "FileSystem");
            ResourceGroupManager::getSingleton().addResourceLocation("./modules/common/materials/model", "FileSystem");
            //            ResourceGroupManager::getSingleton().addResourceLocation("./modules/minidemo/materials/model",
            //            "FileSystem");
            ResourceGroupManager::getSingleton().addResourceLocation("./modules/common/materials/tiled", "FileSystem");
            //            ResourceGroupManager::getSingleton().addResourceLocation("./modules/minidemo/materials/tiled",
            //            "FileSystem");
