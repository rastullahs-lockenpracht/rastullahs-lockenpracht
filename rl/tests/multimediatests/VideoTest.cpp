...
public:
    ...
    void setUp()
    {
        ...
        OgreCEGUIRenderer* rend = new OgreCEGUIRenderer(window, Ogre::RENDER_QUEUE_OVERLAY, false, 3000, mSceneMgr);
        ...
        FrameWindow* frame
            = (FrameWindow*)WindowManager::getSingleton().createWindow("RastullahLook/FrameWindow", "testWindow");
        ...
        mVideo->play();
        StaticImage* image
            = (StaticImage*)WindowManager::getSingleton().createWindow("RastullahLook/StaticImage", "testWindow/image");
        ...
        if (mVideo->getTexture())
        {
            ...
            Imageset* img = ImagesetManager::getSingleton().createImageset(temp, mVideo->getTexture());
...
#endif
{
    ...
    try
    { // This try-catch provides a nice way of popping up errors if they occur.
