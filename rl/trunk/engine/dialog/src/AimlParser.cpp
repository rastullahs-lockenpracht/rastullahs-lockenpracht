...
namespace rl
{
// parsen von startup.xml und *.aiml-files, adopted from jAlice
...
{
	/*	Diese Methode sollte noch aufgeteilt werden, bzw. Sicherheiten eingebaut werden damit
		keine Fehlermeldungen entstehen bei Dateien im falschen Format
	*/
