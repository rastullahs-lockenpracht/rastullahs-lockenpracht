...
*/
#ifndef __Fmod3Listener_H__
#define __Fmod3Listener_H__
...
namespace rl {
    ...
    * @version 2.0
    */
    class _RlFmod3DriverExport Fmod3Listener : public ListenerMovable
    {
    private:
    ...
    public:
        /// Konstruktor
        Fmod3Listener(const Ogre::String& name);
        /// Destruktor
        virtual ~Fmod3Listener();
        /// Moveable-Typ
