...
#ifndef __OpenALDriverPrerequisites_H__
#define __OpenALDriverPrerequisites_H__

#include "RastullahPrerequisites.h"

#if OGRE_PLATFORM == OGRE_PLATFORM_WIN32
// Export control
#   if defined( RLOPENALDRIVER_EXPORTS )
#       define _RlOpenALDriverExport __declspec( dllexport )
#   else
...
#endif //__OpenALDriverPrerequisites_H__
