...
MainWindow::MainWindow()
{
    ...
    str_headerlabels << tr("Type") << tr("ID")
                     << tr("Name"); // hier wird eine QStringlist erstellt, die alle Listenueberschriften erhaellt
    ...
    connect(
        str_structur, SIGNAL(itemDoubleClicked(QTreeWidgetItem*, int)), this, SLOT(changePage(QTreeWidgetItem*, int)));
...
bool MainWindow::okToDelete()
{
    ...
    int r = QMessageBox::warning(this, tr("RL-Dialog"), optOrRes, QMessageBox::Yes | QMessageBox::Default,
...
bool MainWindow::okToContinue()
{
    if (isWindowModified())
    {
        int r = QMessageBox::warning(this, tr("RL-Dialog"),
            tr("Dieser Dialog wurde noch nicht gespeichert!.\n Willst du ihn jetzt speichern?"),
