...
namespace rl
{
    ...
    void XmlProcessor::setAttributeValueAsIntegerPair(
        TiXmlElement* element, const char* const name, IntPair value) const
    {
    ...
    void XmlProcessor::setAttributeValueAsIntegerTriple(
        TiXmlElement* element, const char* const name, Tripel<int> value) const
    {
    ...
    Tripel<int> XmlProcessor::getAttributeValueAsIntegerTriple(
        const TiXmlElement* element, const char* const name) const
    {
    ...
    void XmlProcessor::setAttributeValueAsString(
        TiXmlElement* element, const char* const name, const CeGuiString& value) const
    {
    ...
    void XmlProcessor::setAttributeValueAsVector3(
        TiXmlElement* element, const char* const name, Ogre::Vector3 value) const
    {
    ...
    void XmlProcessor::setAttributeValueAsQuaternion(
        TiXmlElement* element, const char* const name, Ogre::Quaternion value) const
    {
