...
namespace rl
{
    ...
    public:
        WriteableFileStreamDataStream(std::fstream* s, bool freeOnClose = true);

        WriteableFileStreamDataStream(const Ogre::String& name, std::fstream* s, bool freeOnClose = true);

        WriteableFileStreamDataStream(const Ogre::String& name, std::fstream* s, size_t size, bool freeOnClose = true);
