...
namespace rl
{
    ...
    class _RlAiExport ManhattanDistance : public AStarHeuristic
    {
    public:
        //! default constructor
        ManhattanDistance();
    ...
    class _RlAiExport DiagonalDistance : public AStarHeuristic
    {
    public:
        //! default constructor
        DiagonalDistance();
    ...
    class _RlAiExport EuclideanDistance : public AStarHeuristic
    {
    public:
        //! default constructor
        EuclideanDistance();
    ...
    class _RlAiExport EuclideanDistanceSquared : public AStarHeuristic
    {
    public:
        //! default constructor
