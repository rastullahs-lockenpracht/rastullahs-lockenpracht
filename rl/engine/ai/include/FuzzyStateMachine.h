...
namespace rl
{
     ...
     */
    template <class Controller> class FuzzyStateMachine : public FuzzyState<Controller>
    {
    public:
         ...
         */
        virtual void setMaxActivity(int count)
        {
            mMaxActiveStates = count;
        }
