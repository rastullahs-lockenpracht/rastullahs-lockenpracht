...
namespace rl
{
     ...
     */
    class _RlAiExport AStar : public DebugVisualisable
    {
    public:
         ...
         */
        AStar(const AStarCosts* costs, const WayPointGraph* wpGraph, const Ogre::Vector3& startPos,
         ...
         */
        void searchFromTo(AStarPath& resultPath, const Ogre::Vector3& startPos, const Ogre::Vector3& endPos);
        ...
        static AStarPath search(
            const WayPointGraph* wpGraph, const Ogre::Vector3& startPos, const Ogre::Vector3& endPos);
