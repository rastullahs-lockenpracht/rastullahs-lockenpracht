...
namespace rl
{
    ...
    public:
        ...
        virtual float calcCost(
            const WayPointGraph* WPGraph, const AStarWayPointNode* wp1, const AStarWayPointNode* wp2) const = 0;
     ...
     */
    class _RlAiExport AStarCostsDefault : public AStarCosts
    {
    public:
        /** default constructor
         * @param Heuristic to use for calculating heuritic values
