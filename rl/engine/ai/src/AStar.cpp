...
namespace rl
{
    ...
    AStar::AStar(const AStarCosts* costs, const WayPointGraph* wpGraph, const Ogre::Vector3& startPos,
    ...
    void AStar::searchFromTo(AStarPath& resultPath, const Ogre::Vector3& startPos, const Ogre::Vector3& endPos)
    {
        mStartPos = startPos;
        mEndPos = endPos;
        search(resultPath);
