...
namespace rl
{
    ...
    PlayAnimationJob::PlayAnimationJob(
        Actor* actor, const Ogre::String& anim, Ogre::Real duration, bool replaceAllAnims)
    ...
    PlayAnimationJob::PlayAnimationJob(Actor* actor, const Ogre::String& anim, int loops, bool replaceAllAnims)
        : Job(false, true, TimeSource::REALTIME_INTERRUPTABLE)
        , mActor(actor)
        , mAnimName(anim)
        , mLoops(loops)
