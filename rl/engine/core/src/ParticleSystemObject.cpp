...
namespace rl
{
    ...
    {
        ParticleSystem* part
            = CoreSubsystem::getSingletonPtr()->getWorld()->getSceneManager()->createParticleSystem(name, partSys);
    ...
    {
        CoreSubsystem::getSingletonPtr()->getWorld()->getSceneManager()->destroyParticleSystem(getParticleSystem());
    }
