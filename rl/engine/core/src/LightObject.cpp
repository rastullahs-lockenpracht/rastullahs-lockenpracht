...
namespace rl
{
    ...
    {
        Light* light = CoreSubsystem::getSingleton().getWorld()->getSceneManager()->createLight(name);
    ...
    {
        CoreSubsystem::getSingleton().getWorld()->getSceneManager()->destroyLight(getLight());
    }
    ...
    void LightObject::setAttenuation(Real range, Real constant, Real linear, Real quadric)
    {
    ...
    void LightObject::setSpotlightRange(Real innerAngle, Real outerAngle, Real falloff)
    {
