...
namespace rl
{
    ...
    class Fmod4SoundStitchingPtr : public Ogre::SharedPtr<Fmod4SoundStitching>
    {
    public:
        Fmod4SoundStitchingPtr()
            : Ogre::SharedPtr<Fmod4SoundStitching>()
        {
        }
        explicit Fmod4SoundStitchingPtr(Fmod4SoundStitching* rep)
            : Ogre::SharedPtr<Fmod4SoundStitching>(rep)
        {
        }
        Fmod4SoundStitchingPtr(const Fmod4SoundStitchingPtr& res)
            : Ogre::SharedPtr<Fmod4SoundStitching>(res)
        {
        }
