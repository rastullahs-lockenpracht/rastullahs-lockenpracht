...
namespace rl
{
    ...
    class Fmod4SoundPtr : public Ogre::SharedPtr<Fmod4Sound>
    {
    public:
        Fmod4SoundPtr()
            : Ogre::SharedPtr<Fmod4Sound>()
        {
        }
        explicit Fmod4SoundPtr(Fmod4Sound* rep)
            : Ogre::SharedPtr<Fmod4Sound>(rep)
        {
        }
        Fmod4SoundPtr(const Fmod4SoundPtr& res)
            : Ogre::SharedPtr<Fmod4Sound>(res)
        {
        }
