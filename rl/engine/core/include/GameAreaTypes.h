...
namespace rl
{
    ...
    public:
        ...
        /// Der minimale abstand, den ein aktor von der zone haben muss, um die zone zu verlassen (um st�ndige wechsel
        /// in und aus der zone zu vermeiden)
    ...
    */
    ...
    class _RlCoreExport GameNewtonBodyAreaType : public GameAreaType
    {
    public:
        /// Konstruktor
    ...
    class _RlCoreExport GameMeshAreaType : public GameNewtonBodyAreaType
    {
    public:
        GameMeshAreaType(Ogre::Entity* entity, GeometryType geomType = GT_CONVEXHULL,
            Ogre::Vector3 offset = Ogre::Vector3::ZERO, Ogre::Quaternion orientation = Ogre::Quaternion::IDENTITY);
    };

    class _RlCoreExport GameSimpleCollisionAreaType : public GameNewtonBodyAreaType
    {
    public:
        GameSimpleCollisionAreaType(Ogre::AxisAlignedBox aabb, GeometryType geomType = GT_BOX,
            Ogre::Vector3 offset = Ogre::Vector3::ZERO, Ogre::Quaternion orientation = Ogre::Quaternion::IDENTITY);
    };
}
