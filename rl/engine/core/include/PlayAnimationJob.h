...
namespace rl
{
    ...
    public:
         ...
         * @param duration the time the animation will be played, if below zero, the animation will be played exactly 1
         * time
         ...
         */
        PlayAnimationJob(Actor* actor, const Ogre::String& anim, Ogre::Real duration, bool replaceAllAnims = true);
         ...
         *                        when this animation is started, <code>false</code> else.
         */
        PlayAnimationJob(Actor* actor, const Ogre::String& anim, int loops = 1, bool replaceAllAnims = true);
