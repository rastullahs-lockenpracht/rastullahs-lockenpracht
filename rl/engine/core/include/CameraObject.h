...
namespace rl
{
    ...
    public:
         ...
         */
        Ogre::Vector3 getDirectionFromScreenPosition(const Ogre::Real& x, const Ogre::Real& y) const;

        Ogre::Ray getCameraToViewportRay(const Ogre::Real& x, const Ogre::Real& y) const;
    };
}
#endif
