...
namespace rl
{
    ...
    class _RlCoreExport Actor : public Ogre::Node::Listener
    {
    public:
        ...
        Actor(const Ogre::String& name, ActorControlledObject* aco = NULL, PhysicalThing* pt = NULL,
         ...
         *
         */
        void placeIntoNode(Ogre::SceneNode* parent, const Ogre::Vector3& offsetPosition = Ogre::Vector3::ZERO,
         ...
         *
         */
        void placeIntoScene(const Ogre::Vector3& position = Ogre::Vector3::ZERO,
            const Ogre::Quaternion& orientation = Ogre::Quaternion::IDENTITY, const Ogre::String& physicsBone = "");
        /// F�gt diesen Aktor in die Szene (der RootNode) ein.
        void placeIntoScene(Ogre::Real px, Ogre::Real py, Ogre::Real pz, Ogre::Real ow, Ogre::Real ox, Ogre::Real oy,
            Ogre::Real oz, const Ogre::String& physicsBone = "");
         ...
         */
        void attach(Actor* actor, const Ogre::String& childSlot = "SLOT_DEFAULT",
         ...
         */
        void attachAxisRot(Actor* actor, const Ogre::String& childSlot = "SLOT_DEFAULT",
            const Ogre::Vector3& offsetPosition = Ogre::Vector3::ZERO,
         ...
         * @param offsetOrientation Die zus�tzliche Drehung
         */
        void attachToSlot(Actor* actor, const Ogre::String& slot, const Ogre::String& childSlot = "SLOT_DEFAULT",
            const Ogre::Vector3& offsetPosition = Ogre::Vector3::ZERO,
            const Ogre::Quaternion& offsetOrientation = Ogre::Quaternion::IDENTITY);
         ...
         * @param offsetRotation Die zus�tzliche Drehung
         */
        void attachToSlotAxisRot(Actor* actor, const Ogre::String& slot, const Ogre::String& childSlot = "SLOT_DEFAULT",
            const Ogre::Vector3& offsetPosition = Ogre::Vector3::ZERO,
            const Ogre::Vector3& offsetAxis = Ogre::Vector3::UNIT_X,
            const Ogre::Radian& offsetRotation = Ogre::Radian(0));
    ...
    private:
        ...
        void doPlaceIntoScene(Ogre::SceneNode* parent, const Ogre::Vector3& position = Ogre::Vector3::ZERO,
            const Ogre::Quaternion& orientation = Ogre::Quaternion::IDENTITY, const Ogre::String& physicsBone = "");
         ...
         * @param offsetOrientation Die zus�tzliche Drehung
         */
        void doAttach(Actor* actor, const Ogre::String& slot, const Ogre::String& childSlot,
