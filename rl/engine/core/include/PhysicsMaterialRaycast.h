...
namespace rl
{
    ...
    public:
         ...
         */
        RaycastInfo execute(OgreNewt::World* world, const OgreNewt::MaterialID* material, const Ogre::Vector3& startpt,
            const Ogre::Vector3& endpt, bool invertmat = false);

        /** executes the Raycast
         * @param world OgreNewt-World
         * @param materials a vector with pairs of a material and a boolean value, that describes if this material
         * should be matched or not If this param is NULL, every material will be found
         * @param startpt start-point of the cast
         * @param endpt end-point of the cast
         * @param invertmat if "true", the ray finds all collisions, which do NOT have the material-id "material"
         */
        RaycastInfo execute(OgreNewt::World* world, const MaterialVector* materials, const Ogre::Vector3& startpt,
            const Ogre::Vector3& endpt, bool invertmat = false);
