...
namespace rl
{
    ...
    public:
         ...
         *
         */
        PhysicalThing(GeometryType geomType, PhysicalObject* po, Ogre::Real mass, bool hullModifier = false);
        ...
        void setGravityOverride(bool override, Ogre::Real x = 0.0f, Ogre::Real y = 0.0f, Ogre::Real z = 0.0f);
    ...
    private:
        ...
        OgreNewt::CollisionPtr createCollision(
            PhysicalObject* po, Ogre::Vector3& inertia, Ogre::Vector3& centerOfMass) const;
