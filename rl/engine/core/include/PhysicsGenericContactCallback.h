...
namespace rl
{
    ...
    public:
        /*!
         * this function is called, when the aabbs of two bodies overlap, return 0 to indicate, that no contact
         * calculation should be initiated. ATTENTION: if 0 is returned, the contact-listeners cannot be called!
         */
