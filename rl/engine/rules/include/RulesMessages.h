...
namespace rl
{
    ...
    typedef MessageType<RLMSG_GAMEEVENTLOG_EVENT_ADDED, GameEventType, CeGuiString> MessageType_GameEventLog_EventAdded;

    typedef MessageType<RLMSG_COMBAT_OPPONENT_ENTERED, Combatant*> MessageType_CombatOpponentEntered;

    typedef MessageType<RLMSG_COMBAT_OPPONENT_LEFT, Combatant*> MessageType_CombatOpponentLeft;

    typedef MessageType<RLMSG_COMBAT_ENDED, bool> MessageType_CombatEnded;
    ...
    typedef MessageType<RLMSG_PLAYERCHAR_DIED, Creature*> MessageType_PlayerCharDied;

    typedef MessageType<RLMSG_PLAYERCHAR_ADDED, Creature*> MessageType_PlayerCharAdded;

    typedef MessageType<RLMSG_PLAYERCHAR_REMOVED, Creature*> MessageType_PlayerCharRemoved;

    typedef MessageType<RLMSG_PLAYERCHAR_ACTIVE_CHANGED, Creature*, Creature*> MessageType_ActivePlayerCharChanged;

    typedef MessageType<RLMSG_PLAYERCHAR_ALL_DIED> MessageType_AllPlayerCharsDied;
}
#endif
