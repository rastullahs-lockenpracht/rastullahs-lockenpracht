...
namespace rl
{
     ...
     */
    class _RlRulesExport CreatureController : public PhysicsController
    {
    public:
         ...
         * @retval false signifies that the change to this movement was not possible (possibly because the present
         * movement forbade it)
         */
        ...
        MeshAnimation* setAnimation(const Ogre::String& name, Ogre::Real speed = 1, unsigned int timesToPlay = 0,
        ...
        /// this method will return the yaw, the creature tries to turn to, if a rotation-movement is activated. if not,
        /// it will return the current yaw
        Ogre::Radian getYaw();
        Ogre::Real getLastMovementChange() const
        {
            return mLastMovementChange;
        }
        MovementType getLastMovementType() const
        {
            return mLastMovementType;
        }
