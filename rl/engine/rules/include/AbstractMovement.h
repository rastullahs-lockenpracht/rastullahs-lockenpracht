...
namespace rl
{
    ...
    {
    public:
        AbstractMovement(CreatureController* movingCreature)
        ...
        /**
         * this signifies that someone tried to change to another movement, but this was not possible (due to
         * canChangeToMovement returning false)
         */
         ...
         * The parameter direction an rotation don't need to obey the rules from isDirectionPossible and
         * isRotationPossible
         * @retval true indicates that the creature should remain active (in order to activate it use
         * CreatureControllerManager::setActive)
         */
         ...
         * @param direction (in local axes); if this function returns false, this variable contains another valid
         * direction (constructed from the given direction)
         */
         ...
         * @param rotation (in local axes and rpm); if the function returns false, this variable contains another valid
         * rotation (constructed from the given rotation)
         */
        virtual bool isRotationPossible(Ogre::Vector3& rotation) const = 0;

        /// this can return true even though movingcreature doesn't call this movement, but another that is using this
        /// movement
        bool isActive() const
        {
            return mActive;
        ...
        virtual Ogre::Real getMovementDefinedValue()
        {
            return 0;
        }
