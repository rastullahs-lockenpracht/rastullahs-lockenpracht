...
namespace rl
{
    WalkMovement::WalkMovement(CreatureController* creature)
        : StandAroundMovement(creature)
    {
    ...
    void WalkMovement::setAnimation(Ogre::Real elapsedTime)
    {
        ...
        MeshAnimation* meshAnim
            = mMovingCreature->setAnimation(mAnim.first, speed * mAnim.second, 0, mAnim.first, weight);
