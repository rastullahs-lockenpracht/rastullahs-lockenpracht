...
namespace rl
{
     ...
     */
    class _RlUiExport MovementControlState : public ControlState,
    ...
    private:
        ...
        /// if the angle between the last camera pos and the character and the new one is smaller than this value, the
        /// camera can move away from the character
