...
namespace rl
{
    ...
    public:
        ...
        void toggleViewMode();
        // set the combatant (must be part of this combat), the camera should focus on (VM_THIRD_PERSON) (only used
        // internally?)
    ...
    private:
        ...
        Ogre::Real
            mCameraSwitchDist; // set by calculateOptimalCameraPositionAndLookAt, dist at which switches to third-person
