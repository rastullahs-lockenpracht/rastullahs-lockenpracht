...
CustomJoint::CustomJoint( unsigned int maxDOF, const Body* body0, const Body* body1 ) : Joint()
{
	...
	if (body1)
		m_joint = NewtonConstraintCreateUserJoint( m_world->getNewtonWorld(), m_maxDOF, CustomJoint::newtonSubmitConstraint, 
...
void _CDECL CustomJoint::newtonSubmitConstraint( const NewtonJoint* me )
{
