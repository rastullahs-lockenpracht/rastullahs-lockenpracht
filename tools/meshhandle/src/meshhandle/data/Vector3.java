...
public class Vector3 {
	...
	public static Vector3 createFromXML(Node node)
	{
		...
		return new Vector3(
				Float.parseFloat(attrs.getNamedItem("x").getNodeValue()),
				Float.parseFloat(attrs.getNamedItem("y").getNodeValue()),
				Float.parseFloat(attrs.getNamedItem("z").getNodeValue()));
	}
